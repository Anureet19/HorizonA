...
//
//            Log.i("Problem Encountered", "Initialized Amplify")
//        } catch (error: AmplifyException) {
//            Log.e("Problem Encountered", "Could not initialize Amplify", error)
//        }
//    }
    ...
    private fun uploadPhoto(imageUri: Uri) {
        ...
        Amplify.Storage.uploadInputStream(
            ...
            { error -> Log.e("Problem Encountered", "Failed upload", error) }
        )
    }
    ...
    private fun downloadPhoto() {
        ...
        Amplify.Storage.downloadFile(
            ...
            { Log.e("Problem Encountered", "Failed download", it) }
        )
    }
